[![Build](https://github.com/xpofei/jwt-middleware/actions/workflows/build.yml/badge.svg)](https://github.com/xpofei/jwt-middleware/actions/workflows/build.yml)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=xpofei_jwt-middleware&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=xpofei_jwt-middleware)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=xpofei_jwt-middleware&metric=coverage)](https://sonarcloud.io/summary/new_code?id=xpofei_jwt-middleware)
...
experimental:
  plugins:
    jwt:
      moduleName: github.com/xpofei/jwt-middleware
      version: v1.3.3
```
...
command:
  ...
  - "--experimental.plugins.jwt.modulename=github.com/xpofei/jwt-middleware"
